...
void debug()  // yea this was ctrl + c  ctrl + p into here, sorry its 4:38 in the morning and im just too tired to make the function to make this really small and neat so enjoy
{
	...
	switch(constantswitch){
		case 0:	lcdPrint(uart2, 2, "kP %f", PIDDebug[pidswitch][0]);lcdPrint(uart1, 2, "kP %f", PIDDebug[pidswitch][0]);break;
		case 1:	lcdPrint(uart2, 2, "kI %f", PIDDebug[pidswitch][1]);lcdPrint(uart1, 2, "kI %f", PIDDebug[pidswitch][1]);break;
		case 2:lcdPrint(uart2, 2, "kD %f", PIDDebug[pidswitch][2]);lcdPrint(uart1, 2, "kD %f", PIDDebug[pidswitch][2]);break;
		default:lcdPrint(uart2, 1, "PID Not found");lcdPrint(uart2, 2, "Make Better Code");lcdPrint(uart1, 1, "PID Not found");lcdPrint(uart1, 2, "Make Better Code");break;}
